  ...
  <a class="navbar-brand" >
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
       ...
       <!--  <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="../adm/admin.php">Inicio</a>
        </li> -->
        <!-- <li class="nav-item">
...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link" href="./admin.php">CREAR USER</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="./edit_user.php">EDITAR USER</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="./user.php">AGREGAR MOTIVO</a>
  </li>
